// Fault-injects Tutorial08's own create*() failure branches - see
...
TEST(Tutorial08FaultInjectionTest,
    ...
    ASSERT_TRUE(window.create("fault-injection-tutorial08"));

    vulkan_graphix::Tutorial08 tutorial;
