...
TEST(Tutorial10IntegrationTest, FullLifecycle) {
    ...
    ASSERT_TRUE(window.create("integration-10"));

    auto tutorial = std::make_shared<vulkan_graphix::Tutorial10>();
    ...
    ASSERT_TRUE(tutorial->createLinePipeline());
    ASSERT_TRUE(tutorial->createCurveVertexBuffer());
