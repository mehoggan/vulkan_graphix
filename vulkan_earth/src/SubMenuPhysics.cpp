...
void SubMenuPhysics::setXPos(GLfloat new_xpos) { this->xPos = new_xpos; }
GLfloat SubMenuPhysics::getYPos() { return this->yPos; }
void SubMenuPhysics::setYPos(GLfloat new_ypos) { this->yPos = new_ypos; }
GLfloat SubMenuPhysics::getZPos() { return this->zPos; }
void SubMenuPhysics::setZPos(GLfloat new_zpos) { this->zPos = new_zpos; }
