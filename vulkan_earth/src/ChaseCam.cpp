...
void ChaseCam::view() {
    ...
    gluLookAt(targetPos[0] -
                      500 * this->targetAt[0] / mag * (this->backFactor) +
                      this->shakeCamPos[0],
              targetPos[1] + this->upFactor + this->shakeCamPos[1],
              targetPos[2] - 500 * this->targetAt[2] / mag +
                      this->shakeCamPos[2],
              targetPos[0] + 200 * this->targetAt[0] / mag +
                      this->shakeCamPos[0],
              targetPos[1] + 200 * this->targetAt[0] / mag +
                      this->shakeCamPos[1],
              targetPos[2] + 200 * this->targetAt[2] / mag +
                      this->shakeCamPos[2],
              0,
              1,
              0);
...
void ChaseCam::updateShakeCam() {
    if (this->shakeCamPos[0] != 0) {
        this->shakeCamPos[0] = this->shakeCamPos[0] / 1.015281239159713;
        if (this->shakeCamPos[0] % 3 == 0) {
            this->shakeCamPos[0] *= -1;
        }
    }
    if (this->shakeCamPos[1] != 0) {
        this->shakeCamPos[1] = this->shakeCamPos[1] / 1.015281239159713;
        if (this->shakeCamPos[1] % 3 == 1) {
            this->shakeCamPos[1] *= -1;
        }
    }
    if (this->shakeCamPos[2] != 0) {
        this->shakeCamPos[2] = this->shakeCamPos[2] / 1.015281239159713;
