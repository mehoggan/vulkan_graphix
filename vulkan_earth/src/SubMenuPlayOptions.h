#ifndef SUB_MENU_PLAY_OPTIONS_H
#define SUB_MENU_PLAY_OPTIONS_H
...
const int num_control_items_po = 6;

class SubMenuPlayOptions : public SubMenu {
public:
    SubMenuPlayOptions();
    SubMenuPlayOptions(int id,
                       GLfloat x_pos,
                       GLfloat y_pos,
                       GLfloat z_pos,
                       GLfloat red,
...
private:
    ...
    GLfloat percent_border;
    TextObject* label;
    ControlItem* sub_menu_button[num_control_items_po];
    ControlItem* button_pressed;
};

#endif  //	SUB_MENU_PLAY_OPTIONS_H