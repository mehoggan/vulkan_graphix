...
SubMenuPlayOptions::SubMenuPlayOptions(int ID,
    ...
    this->subMenuButton[1] = new ControlItemCheckBox(
            this->xPos + (this->width / 2) - (0.3 * this->width),
            ...
            0.06 * (this->height),
            "Status Bar");
    this->subMenuButton[2] = new ControlItemSelectionBox(
            this->xPos + (this->width / 2) - (0.3 * this->width),
    ...
    this->subMenuButton[4] = new ControlItemSelectionBox(
            ...
            "Talking Tanks",
            "Yes/No/");
    this->subMenuButton[5] = new ControlItemSelectionBox(
            this->xPos + (this->width / 2) - (0.3 * this->width),
...
int SubMenuPlayOptions::getUNIQUEIDENTIFIER() {
    return this->UNIQUEIDENTIFIER;
}
void SubMenuPlayOptions::setUNIQUEIDENTIFIER(int ID) {
    this->UNIQUEIDENTIFIER = ID;
}
