...
void SubMenuPlayOptions::setXPos(GLfloat new_xpos) { this->xPos = new_xpos; }
GLfloat SubMenuPlayOptions::getYPos() { return this->yPos; }
void SubMenuPlayOptions::setYPos(GLfloat new_ypos) { this->yPos = new_ypos; }
GLfloat SubMenuPlayOptions::getZPos() { return this->zPos; }
void SubMenuPlayOptions::setZPos(GLfloat new_zpos) { this->zPos = new_zpos; }
