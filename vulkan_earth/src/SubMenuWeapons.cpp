...
void SubMenuWeapons::setXPos(GLfloat new_xpos) { this->xPos = new_xpos; }
GLfloat SubMenuWeapons::getYPos() { return this->yPos; }
void SubMenuWeapons::setYPos(GLfloat new_ypos) { this->yPos = new_ypos; }
GLfloat SubMenuWeapons::getZPos() { return this->zPos; }
void SubMenuWeapons::setZPos(GLfloat new_zpos) { this->zPos = new_zpos; }
