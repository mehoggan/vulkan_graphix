...
void playSFX(int type) {
    if (type == BIG_CLICK) {
        ...
        if (Mix_Playing(6) == 0) Mix_PlayChannel(6, sfx[type], 0);
    } else if (type == WAVE2) {
        if (Mix_Playing(6) == 0) Mix_PlayChannel(6, sfx[type], 0);
    } else if (type == WAVE3) {
        if (Mix_Playing(6) == 0) Mix_PlayChannel(6, sfx[type], 0);
    } else if (type == SEAGULLS1) {
        if (Mix_Playing(7) == 0) Mix_PlayChannel(7, sfx[type], 0);
        ...
        if (Mix_Playing(2) == 0) Mix_PlayChannel(2, sfx[type], -1);
    } else if (type == TANK_CONTROL2) {
        if (Mix_Playing(3) == 0) Mix_PlayChannel(3, sfx[type], -1);
        ...
        if (Mix_Playing(1) == 0) Mix_PlayChannel(1, sfx[type], 0);
