...
Tank::Tank() {
    ...
    Vector back(0, 0, 0);
    this->tankAlive = true;
    this->smokeGen = nullptr;
    this->acidGen = nullptr;
    this->floatGen = nullptr;
}
Tank::~Tank() {
    if (this->smokeGen) {
...
void Tank::printTurretMatrix() {
    ...
    cout << "|" << this->turretMatrix[0] << " " << this->turretMatrix[4] << " "
         << this->turretMatrix[8] << " " << this->turretMatrix[12] << "|"
         << endl;
    cout << "|" << this->turretMatrix[1] << " " << this->turretMatrix[5] << " "
         << this->turretMatrix[9] << " " << this->turretMatrix[13] << "|"
         << endl;
    cout << "|" << this->turretMatrix[2] << " " << this->turretMatrix[6] << " "
         << this->turretMatrix[10] << " " << this->turretMatrix[14] << "|"
         << endl;
    cout << "|" << this->turretMatrix[3] << " " << this->turretMatrix[7] << " "
         << this->turretMatrix[11] << " " << this->turretMatrix[15] << "|"
         << endl;
}

void Tank::printHeadMatrix() {
    cout << " Head Matrix " << endl;
    cout << "|" << this->headMatrix[0] << " " << this->headMatrix[4] << " "
         << this->headMatrix[8] << " " << this->headMatrix[12] << "|" << endl;
    cout << "|" << this->headMatrix[1] << " " << this->headMatrix[5] << " "
         << this->headMatrix[9] << " " << this->headMatrix[13] << "|" << endl;
    cout << "|" << this->headMatrix[2] << " " << this->headMatrix[6] << " "
         << this->headMatrix[10] << " " << this->headMatrix[14] << "|" << endl;
    cout << "|" << this->headMatrix[3] << " " << this->headMatrix[7] << " "
         << this->headMatrix[11] << " " << this->headMatrix[15] << "|" << endl;
}

void Tank::printBodyMatrix() {
    cout << " Body Matrix " << endl;
    cout << "|" << this->bodyMatrix[0] << " " << this->bodyMatrix[4] << " "
         << this->bodyMatrix[8] << " " << this->bodyMatrix[12] << "|" << endl;
    cout << "|" << this->bodyMatrix[1] << " " << this->bodyMatrix[5] << " "
         << this->bodyMatrix[9] << " " << this->bodyMatrix[13] << "|" << endl;
    cout << "|" << this->bodyMatrix[2] << " " << this->bodyMatrix[6] << " "
         << this->bodyMatrix[10] << " " << this->bodyMatrix[14] << "|" << endl;
    cout << "|" << this->bodyMatrix[3] << " " << this->bodyMatrix[7] << " "
         << this->bodyMatrix[11] << " " << this->bodyMatrix[15] << "|" << endl;
    cout << "+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
         << endl;
}
...
void Tank::setTankPos(GLfloat x, GLfloat y, GLfloat z) {
    ...
    this->headMatrix[12] = this->bodyMatrix[12] +
                           this->headOffset[0] * this->bodyMatrix[0] +
                           this->headOffset[1] * this->bodyMatrix[4] +
                           this->headOffset[2] * this->bodyMatrix[8];
    this->headMatrix[13] = this->bodyMatrix[13] +
                           this->headOffset[0] * this->bodyMatrix[1] +
                           this->headOffset[1] * this->bodyMatrix[5] +
                           this->headOffset[2] * this->bodyMatrix[9];
    this->headMatrix[14] = this->bodyMatrix[14] +
                           this->headOffset[0] * this->bodyMatrix[2] +
                           this->headOffset[1] * this->bodyMatrix[6] +
                           this->headOffset[2] * this->bodyMatrix[10];

    this->turretMatrix[12] = this->headMatrix[12] +
                             this->turretOffset[0] * this->headMatrix[0] +
                             this->turretOffset[1] * this->headMatrix[4] +
                             this->turretOffset[2] * this->headMatrix[8];
    this->turretMatrix[13] = this->headMatrix[13] +
                             this->turretOffset[0] * this->headMatrix[1] +
                             this->turretOffset[1] * this->headMatrix[5] +
                             this->turretOffset[2] * this->headMatrix[9];
    this->turretMatrix[14] = this->headMatrix[14] +
                             this->turretOffset[0] * this->headMatrix[2] +
                             this->turretOffset[1] * this->headMatrix[6] +
                             this->turretOffset[2] * this->headMatrix[10];
    this->updateHitBox();
    if (this->smokeGen)
        this->smokeGen->update(this->bodyMatrix[12] + this->bodyOffset[0] +
                                       this->headOffset[0],
                               this->bodyMatrix[13] + this->bodyOffset[1] +
                                       this->headOffset[1],
                               this->bodyMatrix[14] + this->bodyOffset[2] +
                                       this->headOffset[2]);
}
...
void Tank::orientTank(Normal* n) {
    ...
    Vector tanks_up(
            this->bodyMatrix[4], this->bodyMatrix[5], this->bodyMatrix[6]);
    Vector perp(this->alignmentVector.compoX,
                this->alignmentVector.compoY,
                this->alignmentVector.compoZ);
    ...
    GLfloat mag = static_cast<GLfloat>(
            sqrt(pow(static_cast<double>(this->rotate_about.compoX), 2.0) +
                 pow(static_cast<double>(this->rotate_about.compoY), 2.0) +
                 pow(static_cast<double>(this->rotate_about.compoZ), 2.0)));
    if (mag != 0) {
        ...
        glRotatef(angle,
                  this->rotate_about.compoZ,
                  this->rotate_about.compoY,
                  this->rotate_about.compoX);
...
void Tank::rotateHead(GLfloat degrees) {
    ...
    GLfloat angle = calcAngleBetweenVectors(Vector(this->headMatrix[4],
                                                   this->headMatrix[5],
                                                   this->headMatrix[6]),
                                            Vector(this->turretMatrix[4],
                                                   this->turretMatrix[5],
                                                   this->turretMatrix[6]));
    ...
    glTranslatef(-this->turretOffset[0],
                 -this->turretOffset[1],
                 -this->turretOffset[2]);
    glRotatef(degrees, 0, 1, 0);
    glTranslatef(this->turretOffset[0],
...
void Tank::rotateTurret(GLfloat degrees) {
    if ((this->turret_degrees + degrees <= 90) &&
        (this->turret_degrees + degrees >= 0)) {
    ...
    if (sqrt(pow((X - this->tankPos.coordX), 2) +
        ...
        if (up.compoX * X + up.compoY * Y + up.compoZ * Z - D <= 0) {
            ...
            plane_x = tankPos.coordX + this->hitBoxLength / 2.0 * at.compoX +
                      this->hitBoxWidth / 2.0 * right.compoX +
                      this->hitBoxHeight / 2.0 * up.compoX;
            plane_y = tankPos.coordY + this->hitBoxLength / 2.0 * at.compoY +
                      this->hitBoxWidth / 2.0 * right.compoY +
                      this->hitBoxHeight / 2.0 * up.compoY;
            ...
            if (right.compoX * X + right.compoY * Y + right.compoZ * Z - D <=
                ...
                if (left.compoX * X + left.compoY * Y + left.compoZ * Z - D <=
                    ...
                    if (at.compoX * X + at.compoY * Y + at.compoZ * Z - D <=
                        ...
                        // back
                        plane_x = tankPos.coordX +
                                  this->hitBoxLength / 2.0 * back.compoX +
                                  this->hitBoxWidth / 2.0 * left.compoX +
                                  this->hitBoxHeight / 2.0 * up.compoX;
                        plane_y = tankPos.coordY +
                                  this->hitBoxLength / 2.0 * back.compoY +
                                  this->hitBoxWidth / 2.0 * left.compoY +
                                  this->hitBoxHeight / 2.0 * up.compoY;
                        plane_z = tankPos.coordZ +
...
bool Tank::isAlive() { return this->tankAlive; }
...
void Tank::adjustPower(GLfloat amount) {
    if (((this->currentPower + amount) <= 10.0) &&
        ((this->currentPower + amount) >= 0.0)) {
...
void Tank::rotateWheel(GLfloat degrees) {
    if (!(this->wheel_degrees + degrees > 90) ||
        (this->wheel_degrees - degrees < 0)) {
...
void Tank::changeHeadTexture(int currentPlayerIndex) {
    if (currentPlayerIndex == 0)
        this->vbo_shader_head->SwapTexture("player1Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 1)
        this->vbo_shader_head->SwapTexture("player2Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 2)
        this->vbo_shader_head->SwapTexture("player3Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 3)
        this->vbo_shader_head->SwapTexture("player4Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 4)
        this->vbo_shader_head->SwapTexture("player5Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 5)
        this->vbo_shader_head->SwapTexture("player6Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 6)
        this->vbo_shader_head->SwapTexture("player7Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 7)
        this->vbo_shader_head->SwapTexture("player8Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 8)
        this->vbo_shader_head->SwapTexture("player9Head.raw", 1024, 1024);
    else if (currentPlayerIndex == 9)
        this->vbo_shader_head->SwapTexture("player10Head.raw", 1024, 1024);
    else {
...
int Tank::getCurrentHeight() { return this->currentHeight; }

void Tank::setCurrentHeight(int curr_height) {
    this->currentHeight = curr_height;
}

int Tank::getPreviousHeight() { return this->previousHeight; }
...
void Tank::setDurationDoubleAction(int value) {
    this->durationDoubleAction = value;
}
