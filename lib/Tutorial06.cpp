...
VkRenderPass& VulkanTutorial06Parameters::getVkRenderPass() {
    return m_vk_render_pass;
}
void VulkanTutorial06Parameters::setVkRenderPass(
        const VkRenderPass& vk_render_pass) {
    m_vk_render_pass = vk_render_pass;
}

const ImageParameters& VulkanTutorial06Parameters::getImageParameters() const {
    return m_image_parameters;
}
ImageParameters& VulkanTutorial06Parameters::getImageParameters() {
    return m_image_parameters;
}
void VulkanTutorial06Parameters::setImageParameters(
        const ImageParameters& image_parameters) {
    m_image_parameters = image_parameters;
}

const DescriptorSetParameters&
VulkanTutorial06Parameters::getDescriptorSetParameters() const {
    return m_descriptor_set_parameters;
}
DescriptorSetParameters&
VulkanTutorial06Parameters::getDescriptorSetParameters() {
    return m_descriptor_set_parameters;
}
void VulkanTutorial06Parameters::setDescriptorSetParameters(
        const DescriptorSetParameters& descriptor_set_parameters) {
    m_descriptor_set_parameters = descriptor_set_parameters;
}

const VkPipelineLayout& VulkanTutorial06Parameters::getVkPipelineLayout()
        const {
    return m_vk_pipeline_layout;
}
VkPipelineLayout& VulkanTutorial06Parameters::getVkPipelineLayout() {
    return m_vk_pipeline_layout;
}
void VulkanTutorial06Parameters::setVkPipelineLayout(
        const VkPipelineLayout& vk_pipeline_layout) {
    m_vk_pipeline_layout = vk_pipeline_layout;
}

const VkPipeline& VulkanTutorial06Parameters::getVkGraphicsPipeline() const {
    return m_vk_graphics_pipeline;
}
VkPipeline& VulkanTutorial06Parameters::getVkGraphicsPipeline() {
    return m_vk_graphics_pipeline;
}
void VulkanTutorial06Parameters::setVkGraphicsPipeline(
        const VkPipeline& vk_graphics_pipeline) {
    m_vk_graphics_pipeline = vk_graphics_pipeline;
}

const BufferParameters& VulkanTutorial06Parameters::getVertexBufferParameters()
        const {
    return m_vertex_buffer;
}
BufferParameters& VulkanTutorial06Parameters::getVertexBufferParameters() {
    return m_vertex_buffer;
}
void VulkanTutorial06Parameters::setVertexBufferParameters(
        const BufferParameters& vertex_buffer) {
    m_vertex_buffer = vertex_buffer;
}

const BufferParameters&
VulkanTutorial06Parameters::getStagingBufferParameters() const {
    return m_staging_buffer;
}
BufferParameters& VulkanTutorial06Parameters::getStagingBufferParameters() {
    return m_staging_buffer;
}
void VulkanTutorial06Parameters::setStagingBufferParameters(
        const BufferParameters& staging_buffer) {
    m_staging_buffer = staging_buffer;
}

const VkCommandPool& VulkanTutorial06Parameters::getVkCommandPool() const {
    return m_vk_command_pool;
}
VkCommandPool& VulkanTutorial06Parameters::getVkCommandPool() {
    return m_vk_command_pool;
}
void VulkanTutorial06Parameters::setVkCommandPool(
        const VkCommandPool& vk_command_pool) {
    m_vk_command_pool = vk_command_pool;
}

const std::vector<RenderingResourceParameters>&
VulkanTutorial06Parameters::getRenderingResources() const {
    return m_rendering_resources;
}
std::vector<RenderingResourceParameters>&
VulkanTutorial06Parameters::getRenderingResources() {
    return m_rendering_resources;
}
void VulkanTutorial06Parameters::setRenderingResources(
...
VulkanTutorial06Parameters::getFinishedRenderingSemaphores() const {
    return m_finished_rendering_semaphores;
}
std::vector<VkSemaphore>&
VulkanTutorial06Parameters::getFinishedRenderingSemaphores() {
    return m_finished_rendering_semaphores;
}
void VulkanTutorial06Parameters::setFinishedRenderingSemaphores(
...
bool Tutorial06::createCommandPool(std::uint32_t queue_family_index,
                                   VkCommandPool* pool) {
...
bool Tutorial06::createCommandBuffers() {
    ...
    std::vector<RenderingResourceParameters>& rendering_resources =
            m_vulkan_tutorial06_parameters.getRenderingResources();
...
bool Tutorial06::createSemaphores() {
    ...
    std::vector<VkSemaphore>& finished_rendering_semaphores =
            m_vulkan_tutorial06_parameters.getFinishedRenderingSemaphores();
...
bool Tutorial06::allocateBufferMemory(VkBuffer buffer,
...
bool Tutorial06::createImage(std::uint32_t width,
                             std::uint32_t height,
                             VkImage* image) {
...
bool Tutorial06::createImageView() {
    ...
    return vkCreateImageView(getVkDevice(),
                             ...
                             nullptr,
                             &image_parameters.getVkImageView()) == VK_SUCCESS;
}
...
bool Tutorial06::updateDescriptorSet() {
    ...
    vkUpdateDescriptorSets(getVkDevice(), 1, &descriptor_writes, 0, nullptr);
    return true;
}
...
bool Tutorial06::createPipeline() {
    Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
            vertex_shader_module = createShaderModule("shader.06.vert.spv");
    Tools::AutoDeleter<VkShaderModule, PFN_vkDestroyShaderModule>
            fragment_shader_module = createShaderModule("shader.06.frag.spv");
    ...
    VkGraphicsPipelineCreateInfo pipeline_create_info = {
            ...
            .layout = m_vulkan_tutorial06_parameters.getVkPipelineLayout(),
...
bool Tutorial06::copyVertexData() {
    const std::vector<Tutorial06VertexData>& vertex_data = getVertexData();
...
bool Tutorial06::createFramebuffer(VkFramebuffer& framebuffer,
...
bool Tutorial06::draw() {
    ...
    RenderingResourceParameters& current_rendering_resource =
            m_vulkan_tutorial06_parameters
...
void Tutorial06::childClear() {
    ...
    destroyBuffer(m_vulkan_tutorial06_parameters.getVertexBufferParameters());
    destroyBuffer(m_vulkan_tutorial06_parameters.getStagingBufferParameters());
    ...
    if (m_vulkan_tutorial06_parameters.getVkPipelineLayout() !=
        VK_NULL_HANDLE) {
